...
@section('content')
    <div class="container card shadow mt-3 mb-3 p-3">
      ...
      <div class="row mb-3 justify-content-center">
        <div class="col-lg-10">
          <form action="/admin/infrastruktur" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
              <label for="sarana" class="form-label">Sarana</label>
              <input type="text" class="form-control @error('sarana') is-invalid @enderror" name="sarana" placeholder="Balai desa" value="{{old('sarana')}}">
              @error('sarana')
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('satuan') is-invalid @enderror" name="satuan" placeholder="unit" value="{{old('satuan')}}">
              @error('satuan')
                  <div class="invalid-feedback">
                    {{$message}}
                  </div>
            ...
            <div class="mb-3">
              <button class="btn text-white w-100" style="background-color: #F88154">
