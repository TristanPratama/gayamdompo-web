...
@section('content')
    <div class="container shadow card mt-3 mb-3 p-3">
      <div class="row mb-3">
        <div class="col-lg-6">
          <h3 class="text-uppercase">Tambah Foto</h3>
        </div>
      ...
      <div class="row mb-3 justify-content-center">
        <div class="col-lg-8">
          <form action="/admin/foto" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              <button type="submit" class="btn w-100 text-light" style="background-color: #F88154"><i class="bi bi-cloud me-1"></i>Simpan</button>
            </div>
          </form>
        </div>
      </div>
