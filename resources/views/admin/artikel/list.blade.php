        ...
        <div class="col-lg-6">
          <form action="/admin/article">
            <div class="input-group mb-3">
              ...
              <button class="btn text-white" type="submit" style="background-color: #F88154"><i class="bi bi-search"></i></button>
            </div>
          </form>
        </div>
        <div class="col-lg-3">
          <a href="/admin/article/create" class="btn shadow text-white" style="background-color: #F88154"><i class="bi bi-plus me-2"></i>Tambah</a>
        </div>
      </div>
      <div class="row mb-3 justify-content-center">
        @if (count($data)>0)
