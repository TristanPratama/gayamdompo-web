<nav class="navbar navbar-expand-lg navbar-dark rounded" style="background-color: #F88154 ">
  <div class="container-fluid">
    <a class="navbar-brand text-white" href="/"><b>Kelurahan Gayamdompo</b></a>
      ...
      <div class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="pemerintahanDropDown">
            ...
            <li><a class="dropdown-item" href="/pemerintahan/struktur">Pemerintahan Kelurahan</a></li>
            <li><a class="dropdown-item" href="/pemerintahan/lpmk">Lembaga Pemberdayaan Masyarakat Kelurahan</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
        ...
        <a class="nav-link text-light" href="/data">Data Kelurahan</a>
        @if (!auth()->user())
