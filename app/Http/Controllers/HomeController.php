...
class HomeController extends Controller
{
    public function index(){
        return view('public/home', [
            'title' => 'Kelurahan Gayamdompo',
            'artikel' => Article::latest()->take(3)->get(),
            'foto' => Photo::latest()->get(),
            'lembaga' => Union::all(),
            'visi' => Vision::all(),
            'kades' => Official::firstWhere('jabatan', 'Kepala Kelurahan'),
            'sekdes' => Official::firstWhere('jabatan', 'Sekretaris Kelurahan'),
            'bendes' => Official::firstWhere('jabatan', 'Bendahara Kelurahan'),
        ]);
    }
    ...
    public function show_bpd(){
        return view('public/bpd', [
            'title' => 'Lembaga Pemberdayaan Masyarakat Kelurahan',
            'data' => Council::all(),
            'lembaga' => Union::all()
        ]);
    }
